...
export async function sendDailyReport(
  ...
  const targetReceiver = recipientEmail || process.env.EMAIL_RECEIVER || "keerthusara2007@gmail.com";
...
export { buildReportHtml, buildStaticChartUrl, generateReportPdfBuffer as generatePdfBuffer };
